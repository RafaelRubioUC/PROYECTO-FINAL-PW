        ...
        <div className="sidebar-account-container" ref={accountRef}>
          ...
          >
            ...
            <div className="sidebar-account-info">
              <span className="sidebar-account-name">{userData?.name || "User"}</span>
              <span className="sidebar-account-role">{userData?.email || ""}</span>
            </div>
          </button>
            ...
            <div className="account-dropdown-menu" role="menu">
              <div className="account-dropdown-header">
                ...
                <div className="account-dropdown-meta">
                  <div className="account-dropdown-name">{userData?.name || "User"}</div>
                  <div className="account-dropdown-email">{userData?.email || ""}</div>
                </div>
              </div>
